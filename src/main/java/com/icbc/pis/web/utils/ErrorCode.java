...
public class ErrorCode {
	...
	public static final int COMPANY_SELECT_ACCOUNTER_ERROR_CODE = 200200;
	...
	public static final String COMPANY_SELECT_ACCOUNTER_ERROR_MESSAGE = "Failed in selecting accounters.";
